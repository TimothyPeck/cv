export default {
  ...
  interests: 'Outside of computing, I like video games, guitar, reading, exploration, cooking and motor sports.',
  language_skills: 'Language skills',
  french_level: 'Bilingual',
  english_level: 'Mother tongue; C1, C2 equivalent grade',
  german_level: 'B2',
  ...
  technos_babble: 'Through my years of studies, I have been able to learn and use a lot of technologies. Here is a list of the ones I\'ve used most recently:',
  thanks: 'Thanks to Jeanne for letting me use her portfolio as a model for mine.',
  projects: 'Projects',
